export default {
  ...
  "P_DocMe": {
   ...
   "content": '<div class="projectBody" itemprop="articleBody"><p>Colombia has made significant progress in healthcare system coverage; in 2020, 97.8% of the population was covered. However, this has not translated into effective and timely access to health services. For example, in 2019, 26% of people did not receive or seek medical care due to issues such as appointment availability, service quality, geographic location of the healthcare center, or the number of bureaucratic procedures.</p><h2>Problem</h2><p>The issue of scheduling medical appointments presents significant challenges for patients and healthcare professionals nationwide. The lack of proper scheduling has become a recurring obstacle affecting the efficiency and quality of medical services.</p><p>This problem manifests through various interrelated factors, ranging from the lack of personalization in medical care to inadequate dates and distant healthcare centers.</p><p>However, all these issues converge at a critical point: the absence of an effective appointment scheduling system. The lack of adequate scheduling leads to negative consequences for both patients and healthcare providers. Patients face difficulties accessing timely and appropriate care due to saturated phone lines, staff shortages, and limited operating hours.</p><p>“Scheduling appointments in a practical and timely manner is one of the greatest challenges for patients nationwide due to saturated phone lines, staff shortages, and limiting operating hours [...]” (Anonymous, 2023).</p><h2>Solution</h2><p>This project involves a medical appointment management system based on a web application to integrate capabilities for personalization, calendar optimization, emergency management, and an AI-powered chatbot. This system aims to improve the patient experience by providing a chatbot that will offer automated responses on various healthcare-related topics. This includes:</p><ul class="ProjectSol"><li>Greetings and welcome messages: Responding to user greetings and providing friendly interactions.</li><li>Information about medical appointments: Providing details on upcoming and past appointments.</li><li>General responses: Answering FAQs and offering basic health information.</li><li>Guidance for symptoms: Offering recommendations on what to do if certain symptoms are present, including when to seek immediate care.</li><li><a href="/Projects/Chatbot">Learn more about the ChatBot</a></li></ul><h2>Responsibilities</h2><p>I designed and implemented a medical appointment scheduling system, improving accessibility and efficiency in appointment management.</p><ul class="ListBadges"><li class="ToolBadge ReactJS"><span><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512"><path d="..."></path></svg>ReactJS</span></li></ul></div>'
  },
  "P_Chatbot": {
