...
export default function Skills() {
    ...
    { id: 6, name: 'Angular', Logo: Angular_Logo },
    { id: 7, name: 'HTML', Logo: HTML_Logo },
    { id: 8, name: 'CSS', Logo: CSS_Logo },
    { id: 9, name: 'ExpressJS', Logo: ExpressJS_Logo },
    { id: 10, name: 'jQuery', Logo: jQuery_Logo },
    { id: 11, name: 'NodeJS', Logo: NodeJS_Logo },
    { id: 12, name: 'MySQL', Logo: MySQL_Logo },
    { id: 13, name: 'Vite', Logo: Vite_Logo },];
